	...
	<div class="row">
		...
		<div class="col-9">
			<h4 class="fw-bold">Sản phẩm mới nhất</h4>
				<div class ="row">
			<form action="/ASM/home/search?index=1&ctid=0" method="post">
					...
					<ul class="pagination justify-content-center">
						<c:if test="${index>1}">
							...
							<li class="page-item px-1"><a class="page-link"
								href="/ASM/home/search?index=${index-1}&ctid=${tagactive}"> <svg
						...
						<c:forEach begin="1" end="${endPage}" var="i">
							<li class="page-item px-1  ${index==i?"active":""}"><a
								class="page-link" href="/ASM/home/search?index=${i}&ctid=${tagactive}">${i}</a></li>
						</c:forEach>
