		...
		<tbody>
			<c:forEach items="${listOrder}" var="order">
				<tr>
					...
					<td><span class="badge bg-${ order.orderStatus==1?"success":"secondary" }">${ order.orderStatus==1?"Verified":"Unverify" }</span>
					</td>
					<td class="text-center">
						<button class="btn btn-success" data-bs-toggle="modal"
							data-bs-target="#modal_verify_${ order.id }">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<form
											action="/ASM/admin/orders/status?act=verify&id=${ order.id }"
											method="post">
					...
					<td class="text-center">
						<button class="btn btn-danger" data-bs-toggle="modal"
							data-bs-target="#modal_unverify_${ order.id }">
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
						...
						<div class="modal fade" id="modal_unverify_${ order.id }"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<form
											action="/ASM/admin/orders/status?act=unverify&id=${ order.id }"
											method="post">
											<button type="button" class="btn btn-secondary"
												data-bs-dismiss="modal">Cancel</button>
				...
				<ul class="pagination justify-content-center">
					<c:if test="${index>1}">
						<li class="page-item px-1 "><a class="page-link"
							href="/ASM/admin/orders/index?index=${index-1}"> <svg
					...
					<c:forEach begin="1" end="${endPage}" var="i">
						<li class="page-item px-1"><a class="page-link ${index==i?"
							active":"unactive"}" href="/ASM/admin/orders/index?index=${i}">${i}</a></li>
					</c:forEach>
