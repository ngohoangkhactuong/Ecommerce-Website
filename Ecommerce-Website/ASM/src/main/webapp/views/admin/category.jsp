...
<div class="row mt-3">
	...
	<div class="col">
		...
		<form action="/ASM/admin/categories/search" method="post">
			<div class="row">
				<div class="col-5">
			...
			<nav aria-label="Page navigation example">
			  ...
			  <c:if test="${index>1}">
			    <li class="page-item px-1">
			      <a class="page-link"  href="/ASM/admin/categories/index?index=${index-1}">
			    ...
			    <c:forEach begin="1" end="${endPage}" var="i">
			    	<li class="page-item px-1"><a class="page-link ${index==i?"active":"unactive"}" href="/ASM/admin/categories/index?index=${i}">${i}</a></li>
			    </c:forEach>
