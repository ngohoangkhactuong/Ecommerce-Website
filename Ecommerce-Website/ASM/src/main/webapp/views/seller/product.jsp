...
<div class="container">
	...
	<div class="row mt-3">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="/ASM/seller/products/create" method="post">
								<label class="form-label">Name</label> <input type="text"
									...
									class="form-label">Price</label> <input type="text"
									name="price" class="form-control" required="required"
									oninvalid="this.setCustomValidity('Không được để trống price')"
									oninput="this.setCustomValidity('')" /> <label
									class="form-label">Image</label> <input type="text"
									name="image" class="form-control" required="required"
									oninvalid="this.setCustomValidity('Không được để trống image')"
									oninput="this.setCustomValidity('')" /> <label
									class="form-label">Descriptions</label> <input type="text"
									name="descriptions" class="form-control" required="required"
									oninvalid="this.setCustomValidity('Không được để trống descriptions')"
									oninput="this.setCustomValidity('')" /> <label
									class="form-label">Color</label> <input type="text"
									name="color" class="form-control" required="required"
									oninvalid="this.setCustomValidity('Không được để trống color')"
									oninput="this.setCustomValidity('')" /> <label
									class="form-label">Stock</label> <input type="text"
								...
								</select> <label class="form-label">Brand</label> <input type="text"
									name="brand" class="form-control" required="required"
									oninvalid="this.setCustomValidity('Không được để trống brand')"
									oninput="this.setCustomValidity('')" /> <label
									class="form-label">Category</label> <select name="catename"
									class="form-control">
		...
		<div class="col">
			...
			<form action="/ASM/seller/products/search?index=1" method="post">
				<div class="row">
					<div class="col-5">
					...
					<tr>
						...
						<td class="text-center">
							<button class="btn btn-primary" data-bs-toggle="modal"
								data-bs-target="#modal_update_${ product.id }">
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
							...
							<div class="modal fade" id="modal_update_${ product.id }"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<form action="/ASM/seller/products/update?id=${product.id}"
											method="post">
											<div class="modal-body" style="text-align: left;">
												<label class="label-control mt-1">Name</label> <input
													class="form-control" type="text" name="name"
													value="${product.name}" /> <label
													class="label-control mt-1">Price</label> <input
													class="form-control" type="text" name="price"
													value="${product.price}" /> <label
													class="label-control mt-1">Image</label> <input
													class="form-control" type="text" name="image"
													value="${product.image}" /> <label
													class="label-control mt-1">Descriptions</label> <input
													class="form-control" type="text" name="descriptions"
													value="${product.descriptions}" /> <label
													class="label-control mt-1">Color</label> <input
													class="form-control" type="text" name="color"
													value="${product.color}" /> <label
													class="label-control mt-1">Stock</label> <input
													class="form-control" type="text" name="stock"
													value="${product.stock}" /> <label class="form-label">Size</label>
												<select class="form-select" name="size">
													...
													<option value="L">L</option>
													<option value="XL">XL</option>
												</select> <label class="label-control mt-1">Brand</label> <input
						...
						<td class="text-center">
							<button class="btn btn-danger" data-bs-toggle="modal"
								data-bs-target="#modal_delete_${ product.id }">
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary"
												data-bs-dismiss="modal">Cancel</button>
											<a href="/ASM/seller/products/delete?id=${ product.id }"
					...
					<ul class="pagination justify-content-center">
						<c:if test="${index>1}">
							<li class="page-item px-1 "><a class="page-link"
								href="/ASM/seller/products/index?index=${index-1}"> <svg
						...
						<c:forEach begin="1" end="${endPage}" var="i">
							<li class="page-item px-1"><a class="page-link ${index==i?"
								active":"unactive"}" href="/ASM/seller/products/index?index=${i}">${i}</a></li>
						</c:forEach>
