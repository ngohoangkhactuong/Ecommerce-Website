...
<div class="container">
	...
	<div class="row mt-3">
		...
		<div class="col">
			...
			<form action="/ASM/seller/products/search" method="post">
				<div class="row">
					<div class="col-5">
					...
					<ul class="pagination justify-content-center">
						<c:if test="${index>1}">
							<li class="page-item px-1 "><a class="page-link"
								href="/ASM/seller/products/search?index=${index-1}"> <svg
						...
						<c:forEach begin="1" end="${endPage}" var="i">
							<li class="page-item px-1"><a class="page-link ${index==i?"
								active":"unactive"}" href="/ASM/seller/products/search?index=${i}">${i}</a></li>
						</c:forEach>
